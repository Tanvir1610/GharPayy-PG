...
export default function TenantProfilePage() {
  ...
  return (
    <DashboardLayout sidebar={<TenantSidebar />} title="My Profile">
          ...
          <CardContent>
            <div className="flex items-center gap-4 mb-6 p-4 bg-[#f8f5f1] rounded-xl">
              ...
              <div>
                ...
                <span className="inline-block mt-1 text-xs bg-brand/10 text-brand px-2 py-0.5 rounded-full capitalize">{user?.role}</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSave} className="space-y-4">
              ...
              <Input id="email" type="email" label="Email" value={user?.email || ''}
                icon={<Mail size={15} />} disabled />
              <Input id="phone" label="Phone Number" value={phone}
