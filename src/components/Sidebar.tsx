    ...
    >
      <div style={{ padding: "20px 20px 16px", borderBottom: "1px solid #161b22" }}>
        <Link href="/dashboard" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
          ...
          <div>
            <div className="font-display" style={{ fontSize: 16, fontWeight: 700, color: "#e6edf3", lineHeight: 1.2 }}>GharPayy</div>
            <div style={{ fontSize: 10, color: "#484f58", letterSpacing: "0.05em" }}>PG MANAGEMENT</div>
          </div>
        </Link>
      </div>
      ...
      <nav style={{ padding: "12px 10px", flex: 1 }}>
        ...
        {navItems.map(({ href, icon: Icon, label }) => {
          ...
          return (
            <Link key={href} href={href} style={{ display: "flex", alignItems: "center", gap: 10, padding: "9px 12px", borderRadius: 8, marginBottom: 2, color: active ? "#f97316" : "#6e7681", background: active ? "rgba(249,115,22,0.1)" : "transparent", border: active ? "1px solid rgba(249,115,22,0.2)" : "1px solid transparent", textDecoration: "none", fontSize: 13, fontWeight: active ? 600 : 400, transition: "all 0.15s" }}>
              <Icon size={15} />
              {label}
              {active && <div style={{ marginLeft: "auto", width: 4, height: 4, borderRadius: "50%", background: "#f97316" }} />}
            </Link>
          );
        })}
      </nav>
      ...
      <div style={{ padding: "0 10px 10px" }}>
        <div style={{ padding: "10px 12px", borderRadius: 8, background: "rgba(249,115,22,0.08)", border: "1px solid rgba(249,115,22,0.15)" }}>
          ...
          <div style={{ fontSize: 11, color: "#6e7681", lineHeight: 1.4 }}>AI-powered lead–property scoring</div>
        </div>
      </div>
